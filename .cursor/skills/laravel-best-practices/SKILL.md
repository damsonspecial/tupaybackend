...
### 2. Repository Pattern → `rules/repository-pattern.md`

- Decouple data access with Interfaces
- Inject Contracts into Actions/Controllers
...
### 6. Eloquent Patterns → `rules/eloquent.md`
...
### 7. Validation & Forms → `rules/validation.md`
...
### 10. Queue & Job Patterns → `rules/queue-jobs.md`
...
### 11. Routing & Controllers → `rules/routing.md`
...
### 12. HTTP Client → `rules/http-client.md`
...
### 13. Events, Notifications & Mail → `rules/events-notifications.md`, `rules/mail.md`
...
### 14. Error Handling → `rules/error-handling.md`
...
### 15. Task Scheduling → `rules/scheduling.md`
...
### 16. Architecture → `rules/architecture.md`
...
1. Identify the file type and select relevant sections (e.g., migration → §17, controller → §1, §4, §6, §7, §11)
